...
const isWithinSeconds = (date: Date, seconds: number) => {
    const today = new Date();
...
const makeRelativeDate = (epoch: number, opts: relativeDateOptions = {}) => {
    let minutes;
    let hours;
    let days;
    let delta = 0;
...
const replaceLocaleTimestamps = (html: ?Element) => {
...
const replaceValidTimestamps = (opts: relativeDateOptions = {}) => {
...
const init = (opts: relativeDateOptions = {}) => {
